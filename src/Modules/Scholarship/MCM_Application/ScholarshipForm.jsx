            ...
            <Grid>
              ...
              <Grid.Col span={6}>
                <Select
                  ...
                  onChange={(value) =>
                    handleInputChange({ target: { name: "father_occ", value } })
                  }
                  data={[
                ...
                <Select
                  ...
                  onChange={(value) =>
                    handleInputChange({ target: { name: "mother_occ", value } })
                  }
                  data={[
                ...
                <TextInput
                  ...
                  value={formData.sister_occupation}
                  onChange={handleInputChange}
                  mt="md"
                />
                <TextInput
                ...
                <TextInput
                  ...
                  name="two_wheeler"
                  placeholder="Enter number of vehicles"
                  value={formData.two_wheeler}
                  onChange={handleInputChange}
                  mt="md"
                />
                <TextInput
                  label="Two Wheeler Description"
                  name="two_wheeler_desc"
                  placeholder="Enter number of vehicles"
                  value={formData.two_wheeler_desc}
                  onChange={handleInputChange}
                  mt="md"
                />
                <TextInput
              ...
              <Grid.Col span={6}>
                <TextInput
                  ...
                  value={formData.father_occ_desc}
                  onChange={handleInputChange}
                  mt="md"
                />
                <TextInput
                  label="Mother's Occupation Description"
                  name="mother_occ_desc"
                  placeholder="Describe mother's occupation"
                  value={formData.mother_occ_desc}
                  onChange={handleInputChange}
                  mt="md"
                />
                <TextInput
                  ...
                  value={formData.brother_occupation}
                  onChange={handleInputChange}
                  mt="md"
                />
                <TextInput
                ...
                <TextInput
                  ...
                  name="four_wheeler_desc"
                  placeholder="Enter vehicle description"
                  value={formData.four_wheeler_desc}
                  onChange={handleInputChange}
                  mt="md"
                />
                <TextInput
